...
<div class="row">
  <form class="form-horizontal" method="post" data-validate="parsley" action="<?=base_url()?>quotes/revisedupdate/<?=$quote->quote_id?>">
    <div class="col-sm-12">      
      <section class="panel">
        <div class="panel-body">
          ...
          <div class="form-group m-b-small">
              <label class="col-lg-3 control-label">Quote NO</label>
              <div class="col-lg-9">
              
              <?php 
			 $revised_quote_no= explode(".",$quote->quote_no);
			 if($revised_quote_no[1]=="")
			 {
				 if($quote->revised_quote_id!="0")
				 {
					 $revised_quote_nos=$quote->quote_no.".1";
					 $revised_quote_no=1;
				 }
				 else
				 {
					
					$revised_quote_no= $quote->revised_quote_no+1;
					$revised_quote_nos=$quote->quote_no.".".$revised_quote_no;
				 }
			 }
			 else
			 {
				 $revised_quote_no[1]++;
				 $revised_quote_nos=$revised_quote_no[0].".".$revised_quote_no[1];
				 $revised_quote_no=$revised_quote_no[1];
				 
			 }
			 
			 if($quote->revised_quote_id=="0")
			 {
				$quote->revised_quote_id=$quote->quote_id; 
			 }
			  $revised_quote_no=$quote->revised_quote_no+1; ?>
                <input type="text"  data-required="true" readonly="readonly" class="form-control" name="quote_no" value="<?=$revised_quote_nos?>">
                <input type="hidden" name="revised_quote_id" value="<?=$quote->revised_quote_id?>" />
                 <input type="hidden" name="revised_quote_no" value="<?=$revised_quote_no;?>" />
            
                 <input type="hidden" name="quote_currency" value="<?=$quote->quote_currency?>" />
                 
                   <input type="hidden" name="deal_id" value="<?=$quote->deal_id?>" />
            ...
            <div class="form-group m-b-small">
              ...
              <div class="col-lg-9">
                <input type="text" name="subject" data-required="true" class="form-control" value="<?=$quote->subject?>">
              </div>
            </div>
            <div class="form-group m-b-small">
              <label class="col-lg-3 control-label">Opportunity</label>
              <div class="col-lg-9 h5">
                <label class="control-label h5 text-primary"><?=$quote->deal_name?></label>
              </div>
            </div>
            <div class="form-group m-b-small">
              <label class="col-lg-3 control-label">Account</label>
              <div class="col-lg-9">
                <label class="control-label h5 text-primary"><?=$quote->company_name?></label>
              </div>
            </div>
            <div class="form-group m-b-small">
                ...
                <div class="btn-group col-xs-12 no-padder">
                  <select name="contact_id" data-required="true" class="select2-option">
                    ...
                    <?php foreach($contacts as $contact) { ?>
                      <option value="<?=$contact->contact_id?>" <? if ($contact->contact_id == $quote->contact_id) { ?>selected="selected"<?php } ?>><?=$contact->name?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
            ...
            <div class="form-group m-b-small">
              <label class="col-lg-3 control-label">Valid Till</label>
              <div class="col-lg-9">
                <input type="text" name="valid_till" data-required="true" class="form-control datepicker" value="<?=$quote->valid_till?date('d-m-Y', strtotime($quote->valid_till)):''?>" data-date-format="dd-mm-yyyy" placeholder="<?=$this->chooseDate?>">
              </div>
            </div>
          </div>
          <div class="col-sm-6">
                ...
                <div class="btn-group col-xs-12 no-padder">
                  <select name="quote_stage" class="select2-option" data-required="true">
                    ...
                    <?php foreach($fields as $quote_stage) { if ($quote_stage->quote_stage) { ?>
                      <option value="<?=$quote_stage->no?>" <? if ($quote_stage->no == $quote->quote_stage) { ?>selected="selected"<?php } ?>><?=$quote_stage->quote_stage?></option>
                    <?php } } ?>
                  </select>
                </div>
              </div>
                ...
                <div class="btn-group col-xs-12 no-padder">
                  <select name="delivery" class="select2-option">
                    ...
                    <?php foreach($fields as $quote_delivery) { if ($quote_delivery->quote_delivery) { ?>
                      <option value="<?=$quote_delivery->quote_delivery?>" <? if ($quote_delivery->quote_delivery == $quote->delivery) { ?>selected="selected"<?php } ?>><?=$quote_delivery->quote_delivery?></option>
                    <?php } } ?>
                  </select>
                </div>
              </div>
                ...
                <div class="btn-group col-xs-12 no-padder">
                  <select name="carrier" class="select2-option">
                    ...
                    <?php foreach($fields as $quote_carrier) { if ($quote_carrier->quote_carrier) { ?>
                      <option value="<?=$quote_carrier->quote_carrier?>" <? if ($quote_carrier->quote_carrier == $quote->carrier) { ?>selected="selected"<?php } ?>><?=$quote_carrier->quote_carrier?></option>
                    <?php } } ?>
                  </select>
                </div>
              </div>
                ...
                <div class="btn-group col-xs-12 no-padder">
                  <select name="payment" class="select2-option">
                    ...
                    <?php foreach($fields as $quote_payment) { if ($quote_payment->quote_payment) { ?>
                      <option value="<?=$quote_payment->quote_payment?>" <? if ($quote_payment->quote_payment == $quote->payment) { ?>selected="selected"<?php } ?>><?=$quote_payment->quote_payment?></option>
                    <?php } } ?>
                  </select>
                </div>
              </div>
            ...
            <div class="form-group m-b-small">
              ...
              <div class="col-lg-9">
                <div class="btn-group col-xs-12 no-padder">
                  <select name="quote_currency" class="select2-option bcz-currency" disabled="disabled" data-required="true">
                    <option value=""><?=$this->chooseOption?></option>
                    <?php foreach($fields as $currency) { if ($currency->currency) { ?>
                      <option value="<?=$currency->currency?>" <? if ($currency->currency == $quote->quote_currency) { ?>selected="selected"<?php } ?>><?=$currency->currency?></option>
                    <?php } } ?>
                  </select>
                </div>
              </div>
            ...
            <div class="panel-body">
              <div class="col-sm-6 billing-address-fields">                  
                ...
                <div class="form-group m-b-small">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="bill_addr" data-required="true" class="form-control" value="<?=$quote->bill_addr?>">
                  </div>
                </div>                
                <div class="form-group m-b-small">
                  <label class="col-lg-3 control-label">Billing City<?=$this->mandatoryFieldIndicator?></label>
                  <div class="col-lg-9">
                    <input type="text" name="bill_city" data-required="true" class="form-control" value="<?=$quote->bill_city?>">
                  </div>
                </div>                
                <div class="form-group m-b-small">
                  <label class="col-lg-3 control-label">Billing State<?=$this->mandatoryFieldIndicator?></label>
                  <div class="col-lg-9">
                    <input type="text" name="bill_state" data-required="true" class="form-control" value="<?=$quote->bill_state?>">
                  </div>
                </div>                
                <div class="form-group m-b-small">
                  <label class="col-lg-3 control-label">Billing Zip Code<?=$this->mandatoryFieldIndicator?></label>
                  <div class="col-lg-9">
                    <input type="text" name="bill_pcode" data-required="true" class="form-control" value="<?=$quote->bill_pcode?>">
                  </div>
                </div>
                <div class="form-group m-b-small">
                    ...
                    <div class="btn-group col-xs-12 no-padder">
                      <select name="bill_country" class="select2-option">
                        ...
                        <?php foreach($fields as $country) { if ($country->country) { ?>
                          <option value="<?=$country->country?>" <? if ($country->country == $quote->bill_country) { ?>selected="selected"<?php } ?>><?=$country->country?></option>
                        <?php } } ?>
                      </select>
                    </div>
                  </div>
              ...
              <div class="col-sm-6 shipping-address-fields">               
                ...
                <div class="form-group m-b-small">
                  ...
                  <div class="col-lg-9">
                    <input type="text" name="ship_addr" data-required="true" class="form-control" value="<?=$quote->ship_addr?>">
                  </div>
                </div>                
                <div class="form-group m-b-small">
                  <label class="col-lg-3 control-label">Shipping City<?=$this->mandatoryFieldIndicator?></label>
                  <div class="col-lg-9">
                    <input type="text" name="ship_city" data-required="true" class="form-control" value="<?=$quote->ship_city?>">
                  </div>
                </div>                
                <div class="form-group m-b-small">
                  <label class="col-lg-3 control-label">Shipping State<?=$this->mandatoryFieldIndicator?></label>
                  <div class="col-lg-9">
                    <input type="text" name="ship_state" data-required="true" class="form-control" value="<?=$quote->ship_state?>">
                  </div>
                </div>                
                <div class="form-group m-b-small">
                  <label class="col-lg-3 control-label">Shipping Zip Code<?=$this->mandatoryFieldIndicator?></label>
                  <div class="col-lg-9">
                    <input type="text" name="ship_pcode" data-required="true" class="form-control" value="<?=$quote->ship_pcode?>">
                  </div>
                </div>
                <div class="form-group m-b-small">
                  ...
                  <div class="col-lg-9">
                    <div class="btn-group col-xs-12 no-padder">
                      <select name="ship_country" class="select2-option">
                        <option value=""><?=$this->chooseOption?></option>
                        <?php foreach($fields as $country) { if ($country->country) { ?>
                          <option value="<?=$country->country?>" <? if ($country->country == $quote->ship_country) { ?>selected="selected"<?php } ?>><?=$country->country?></option>
                        <?php } } ?>
                      </select>
                    </div>
                  </div>
      ...
      <textarea name="terms" placeholder="Terms & Conditions" rows="2" class="form-control col-sm-12"><?=$quote->terms?></textarea>
      <textarea name="q_description" placeholder="Remarks" rows="2" class="form-control col-sm-12 m-t"><?=$quote->q_description?></textarea>
      ...
      <div class="panel-group m-b m-t" id="accordion3">
        <div class="panel">
          ...
          <div id="collapseTwo" class="panel-collapse collapse in">
            <div class="panel-body scroll scroll-x">
              ...
              <?php $hj=0; foreach ($quote->items as $ikey => $item) {$hj++; ?>
              <div class="row m-t-mini padder bcz-quote-item <?=$hj?>">
                ...
                <div class="col-sm-1 text-center padder-r-mini no-padder-l m-t-mini">
                  <div class="form-group m-b-none">
                    ...
                    <div class="col-xs-12">
                      <input type="text" name="qty[]" class="form-control bcz-quote-item-field bcz-quote-qty" value="<?=$item['qty']?>" data-required="true" data-type="number">
                    </div>
                  </div>
                </div>
                <div class="col-sm-2 text-center padder-r-mini no-padder-l m-t-mini">
                  <div class="form-group m-b-none">
                    ...
                    <div class="col-xs-12">
                      <input type="text" name="price[]" readonly="readonly" class="form-control bcz-quote-item-field bcz-quote-price" value="<?=$item['price']?>" data-required="true">
                    </div>
                  </div>
                </div>
                <div class="col-sm-1 text-center padder-r-mini no-padder-l m-t-mini">
                ...
                <div class="col-sm-2 text-center padder-r-mini no-padder-l m-t-mini ">
                  <div class="form-group m-b-none">
                    ...
                    <div class="col-sm-12">
                      <input type="text" name="amount[]" class="form-control bcz-quote-item-field bcz-quote-amount" readonly="readonly" value="<?=$item['amount']?>" data-required="true">
                    </div>
                  </div>
                </div>
              </div>
  	  ...
  	  <div class="col-xs-12 text-center padder-r-mini no-padder-l m-t-mini"><a href="#" class="btn btn-primary btn-xs bcz-btn-delete-quote-item pull-right">Delete</a></div>
              ...
              <?php if (!$quote->item5_id) { ?>
              <div class="row m-t padder">
                <div class="col-sm-3 padder-r-mini no-padder-l">                  
                  <div class="form-group m-b-none">
                    <div class="col-xs-12">
              ...
              <div class="row m-t padder">    
                <div class="col-sm-4 pull-right no-padder">
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" name="frieght" class="form-control bcz-quote-items-frieght" value="<?=$quote->frieght?>" data-type="number">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-lg-3 control-label">Installation:</label>
                    <div class="col-sm-7">
                      <input type="text" name="install" class="form-control bcz-quote-items-install" value="<?=$quote->install?>" data-type="number">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-lg-3 control-label">Total:<?=$this->mandatoryFieldIndicator?></label>
                    <div class="col-sm-7">
                      <input type="text" name="total" class="form-control bcz-quote-items-total" data-required="true" readonly="readonly" value="<?=$quote->total?>">
                    </div>
                  </div>
                </div>
              </div>
