...
<section class="panel">
 ...
 <table class="table table-striped m-b-none bcz-data-table bcz-data-table1" data-ride="datatables" <?php $colWidth = 100/count($cols); if ($sourcePath) { ?>   data-source="<?=base_url().$sourcePath?>" <?php } ?> >
      <thead>
        <tr>
