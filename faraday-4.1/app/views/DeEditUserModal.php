<form class="form-horizontal" method="post" data-validate="parsley" action="<?=base_url()?>settings/updateinactive">
  <div class="modal-dialog">
    <div class="modal-content"><!-- .modal-content -->
      ...
      <div class="modal-footer">
        ...
        <button id="update_user1" type="submit" class="btn btn-sm btn-primary">Save</button>
