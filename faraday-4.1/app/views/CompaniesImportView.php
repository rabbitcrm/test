...
<div class="row">
  <form class="form-horizontal" method="post" data-validate="parsley" action="<?=base_url()?>companies/importcsv" enctype="multipart/form-data">
    <div class="col-sm-12">      
      <section class="panel">
        <div class="panel-body">
          <div class="col-sm-6">
          <div class="form-group m-b-small">
              <label class="col-lg-3 control-label">Companies File<?=$this->mandatoryFieldIndicator?></label>
              <div class="col-lg-9">
