<!-- .modal -->
<div id="create_contact_deal_modal" class="modal fade">
  <form class="form-horizontal " method="post" data-validate="parsley" action="<?=base_url()?>contacts/modalsubmit">
    <div class="modal-dialog">
      <div class="modal-content"><!-- .modal-content -->
        ...
        <div class="modal-body">
          ...
          <div class="form-group m-b-small">
            ...
            <div class="col-lg-9">
              ...
              <input type="hidden" name="company_id" id="con_company_id">
              
                <input type="text"   class="form-control" id="con_company_name" readonly="readonly">
              
             <?php /*?>   <select name="company_id" data-required="true" class="select2-option" <? if ($add_deal_company_id) { ?>disabled="disabled"<?php } ?>>
                ...
                <? if ($add_deal_company_id) { ?><input type="hidden" name="company_id" class="form-control" value="<?=$add_deal_company_id?>"><?php } ?><?php */?>
              </div>
            </div>
          </div>
          <div class="form-group m-b-small">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn btn-sm btn-primary" id="add_contact_deal_modal">Add</button>
        </div>
      </div><!-- /.modal-content -->
    </div>
  </form>
