...
<div class="row">
  <form class="form-horizontal" method="post" data-validate="parsley" action="<?=base_url()?>quotes/update/<?=$quote->quote_id?>">
    <div class="col-sm-12">      
      <section class="panel">
        <div class="panel-body">
          ...
          <div class="form-group m-b-small">
              ...
              <div class="col-lg-9">
                <input type="text"  data-required="true" readonly="readonly" class="form-control" value="<?=$quote->quote_no?>">
              </div>
            </div>
            <div class="form-group m-b-small">
        ...
        <div class="panel">
          ...
          <div id="collapseTwo" class="panel-collapse collapse in">
            <div class="panel-body scroll scroll-x">
              ...
              <?php foreach ($quote->items as $ikey => $item) { ?>
              <div class="row m-t-mini padder bcz-quote-item">
                ...
                <div class="col-sm-2 text-center padder-r-mini no-padder-l m-t-mini">
                  <div class="form-group m-b-none">
                    ...
                    <div class="col-xs-12">
                      <input type="text" name="price[]"  class="form-control bcz-quote-item-field bcz-quote-price" value="<?=$item['price']?>" data-required="true">
                    </div>
                  </div>
                </div>
                <div class="col-sm-1 text-center padder-r-mini no-padder-l m-t-mini">
                ...
                <div class="col-sm-1 text-center padder-r-mini no-padder-l m-t-mini">                  
                  <div class="form-group m-b-none">
                    <div class="col-xs-12 text-left m-t-small m-b-mini h5 visible-xs">VAT %</div>
                    <div class="btn-group col-xs-12">
