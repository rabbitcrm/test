<!-- .scrollable -->
<section class="" id="latest_deals">
  <header class="panel-heading h5 body_home">Latest Opportunities <div class="float_right">Amount</div></header>

<?php /*?>    <?php if ($deals[0]) { foreach ($deals as $did => $deal) { ?>
      <article class="media">
    ...
    <?php } ?><?php */?>
    <?php 
	 $this->load->view('DataTableViewOpp', array('className'=>'latest_opp','thead'=>'false','cols'=>$topoppcols,'sourcePath' => 'dashboard/getlatestopp')); ?>
