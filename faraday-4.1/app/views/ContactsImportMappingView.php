...
<div class="row">
  <form class="form-horizontal" method="post" data-validate="parsley" action="<?=base_url()?>contacts/importmapping" enctype="multipart/form-data">
    <div class="col-sm-12">      
      <section class="panel">
        <div class="panel-body">
      
         <?php foreach($contact_table_data as $table_data1) {  if($table_data1['value']!="")
			 {
			  ?>
           <div class="col-sm-6">
          <div class="form-group m-b-small">
           ...
           <?php foreach($contact_table_data as $table_data) { ?>
