...
<div class="row">
  <form class="form-horizontal" method="post" data-validate="parsley" action="<?=base_url()?>campaign/submit">
    <div class="col-sm-12">      
      <section class="panel">
        <div class="panel-body">
          <div class="col-sm-6">
            <div class="form-group m-b-small">
              ...
              <div class="col-lg-9">
                <input type="text" name="campaign_name" class="form-control" data-required="true" >
              </div>
            </div>
            ...
            <div class="form-group m-b-small">
              ...
              <div class="btn-group col-xs-12 no-padder">
                <select name="assigned_to" class="select2-option" data-required="true">
              ...
              <div class="btn-group col-xs-12 no-padder">
                ...
                <option value=""><?=$this->chooseOption?></option>
                    <?php foreach($campaign_types as $campaign_type) { ?>
                      <option value="<?=$campaign_type->no?>"> <?=$campaign_type->campaign_type?></option>
                    <?php } ?>
                  </select>
                  </div>
              ...
              <div class="col-lg-9">
                ...
                <option value=""><?=$this->chooseOption?></option>
                    <?php foreach($campaign_status as $status) { ?>
                      <option value="<?=$status->no?>"> <?=$status->campaign_status?></option>
                    <?php } ?>
                  </select>
                  </div>
              </div>
          ...
          <div class="col-sm-6">
            ...
            <div class="form-group m-b-small">
              ...
              <div class="col-lg-9">
                 <input type="text" name="product" class="form-control" data-required="true" >
              </div>
            </div>
            <div class="form-group m-b-small">
              <label class="col-lg-3 control-label">Exp.Close Date</label>
              <div class="col-lg-9">
           <input type="text" name="closedate" id="campaign_type"class="form-control datepicker parsley-validated" data-date-format="dd-mm-yyyy" placeholder="-- Choose Date --">
              </div>
            </div>
            <div class="form-group m-b-small">
            ...
            <div class="form-group m-b-small">
              ...
              <div class="col-lg-9">
                <textarea name="description" rows="3" class="form-control" data-trigger="keyup" data-rangelength="[20,1000]" data-required="true"></textarea>
              </div>
            </div>
        ...
        <div class="panel">
          ...
          <div id="collapseOne" class="panel-collapse collapse">
            <div class="panel-body">
              ...
              <div class="col-lg-9">
                <input type="text" name="sales_count" class="form-control" >
              </div>
            </div>
                  <div class="form-group m-b-small">
              ...
              <div class="col-lg-9">
                ...
                <option value=""><?=$this->chooseOption?></option>
                    <?php foreach($responses as $response) { ?>
                      <option value="<?=$response->no?>"> <?=$response->campaign_response?></option>
                    <?php } ?>
                  </select>
                  </div>
              </div>
              ...
              <div class="col-lg-9">
                <input type="text" name="num_sent" class="form-control" >
              </div>
            </div>
    ...
    <div class="col-sm-12">
      <div class="form-group">
        <button type="submit" class="btn btn-primary m-l" id="create_campaign">Create</button>
      </div>
    </div>
  </form>
</div>