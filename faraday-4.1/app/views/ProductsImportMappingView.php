<div class="clearfix">
  <h3>Products Mapping</h3>
</div>

<div class="row"><div class="col-sm-6"><? $this->load->view('MessagesView', array(messages => $messages)) ?></div></div>
<div class="row">
  <form class="form-horizontal" method="post" data-validate="parsley" action="<?=base_url()?>products/importmapping" enctype="multipart/form-data">
    <div class="col-sm-12">      
      <section class="panel">
        <div class="panel-body">
      
         <?php foreach($product_table_data as $table_data1) {
          ...
          <div class="form-group m-b-small">
           ...
           <?php foreach($product_table_data as $table_data) { ?>
         ...
         <div class="col-sm-6">
          <div class="form-group m-b-small">
             ...
             <div class="btn-group col-xs-11 no-padder">
                    ...
                    <option value=""><?=$this->chooseOption?></option>
                    <?php foreach($fields as $source) { if ($source->product_category) { ?>
                      <option value="<?=$source->no?>" ><?=$source->product_category?></option>
                    <?php } } ?>
                  </select>
